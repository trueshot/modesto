...
class ModelTEditor {
  ...
  // Vantages (5.15) do NOT live here: George ruled 2026-08-31 that a vantage
  // is a drone view, not plant — the normative .modelT.json holds facility
  // facts only. Writer = tools/vantages-store.js (companion vantages.json,
  // ungated). — modeltbabylon gen-16
